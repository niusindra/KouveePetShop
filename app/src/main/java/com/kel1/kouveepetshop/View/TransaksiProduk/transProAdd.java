...
public class transProAdd extends AppCompatActivity {
    ...
    private TextView namaCust, telpCust, almtCust, namaHwn, jenisHwn;
...
//                                                    Call<cudDataMaster> detailPengadaanCall = apiService.addDetailPengadaan(null,detailProdukDAOList.get(i).getId_produk(),detailProdukDAOList.get(i).getSatuan(),detailProdukDAOList.get(i).getJml_pengadaan_produk());
