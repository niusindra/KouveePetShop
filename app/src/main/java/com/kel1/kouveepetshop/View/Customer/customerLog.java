    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(nama.getText().toString().isEmpty() || alamat.getText().toString().isEmpty() || date.getText().toString().isEmpty() || telp.getText().toString().isEmpty()){
                    ...
                    customerCall.enqueue(new Callback<cudCustomer>(){
                        public void onResponse(Call<cudCustomer> call, Response<cudCustomer> response){
                            Toast.makeText(customerLog.this,"Berhasil edit",Toast.LENGTH_SHORT).show();
                            startIntent();
                        }
                        public void onFailure(Call<cudCustomer> call, Throwable t){
                            Toast.makeText(customerLog.this,"Masalah koneksi",Toast.LENGTH_SHORT).show();
                            startIntent();
                        }
                    });
                }
        ...
        delBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                customerCall.enqueue(new Callback<cudCustomer>(){
                    public void onResponse(Call<cudCustomer> call, Response<cudCustomer> response){
                        Toast.makeText(customerLog.this,"Berhasil dihapus",Toast.LENGTH_SHORT).show();
                        startIntent();
                    }
                    public void onFailure(Call<cudCustomer> call,Throwable t){
                        Toast.makeText(customerLog.this,"Masalah koneksi",Toast.LENGTH_SHORT).show();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(customerLog.this, customerShow.class);
