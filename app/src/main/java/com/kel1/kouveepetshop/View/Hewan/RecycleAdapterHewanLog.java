...
public class RecycleAdapterHewanLog extends RecyclerView.Adapter<RecycleAdapterHewanLog.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(@NonNull View itemView){
            ...
            mCreatedAt=itemView.findViewById(R.id.hwncreatedat);
            mCreatedBy=itemView.findViewById(R.id.hwncreatedby);
            mEditedAt=itemView.findViewById(R.id.hwneditedat);
            mEditedBy=itemView.findViewById(R.id.hwneditedby);
            mDeletedAt=itemView.findViewById(R.id.hwndeletedat);
            mDeletedBy=itemView.findViewById(R.id.hwndeletedby);
